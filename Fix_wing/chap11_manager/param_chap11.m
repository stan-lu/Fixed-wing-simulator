...
a_phi1 = -0.5 * P.rho * Va^2 * P.S_wing * P.b * P.C_p_p * P.b / (2 * Va);
a_phi2 = 0.5 * P.rho * Va^2 * P.S_wing * P.b * P.C_p_delta_a;
...
a_theta1 = -P.rho * Va^2 * P.c * P.S_wing * P.C_m_q * P.c / (2 * P.Jy * 2 * Va);
a_theta2 = -P.rho * Va^2 * P.c * P.S_wing * P.C_m_alpha / (2 * P.Jy);
a_theta3 = P.rho * Va^2 * P.c * P.S_wing * P.C_m_delta_e / (2 * P.Jy);
...
% 路径制导的参数
% P.k_path=0.004; % for model
P.k_path=0.027;  % for full simulation
